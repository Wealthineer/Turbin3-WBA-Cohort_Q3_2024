...
use crate::{error::ErrorCode, state::{StakeAccount, StakeConfig, UserAccount}};
...
impl<'info> Stake<'info> {
    pub fn stake(&mut self, bumps: &StakeBumps) -> Result<()> {
        ...
        let cpi_accounts = Approve {
            to: self.mint_ata.to_account_info(), //delegate authority of this account
            delegate: self.stake_account.to_account_info(), //to this delegate
            authority: self.user.to_account_info(), //authorized by the current owner
        };
