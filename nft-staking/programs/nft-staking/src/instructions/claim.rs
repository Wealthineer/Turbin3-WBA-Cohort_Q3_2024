...
use anchor_spl::{associated_token::AssociatedToken, token::{Mint, Token, TokenAccount, mint_to, MintTo}};
...
impl<'info> Claim<'info> {
    pub fn claim(&mut self) -> Result<()> {
        ...
        //mint amount of tokens according to points
